function love.load()
	...
	load_model_for_edit("ressource","model")
...
function love.draw()
	...
	love.graphics.print( "fps="..(math.floor(fps*10)/10).." Hz" , love.graphics.getWidth()-160 , 0 )
	love.graphics.print( "txt="..txt.."" , 0 , 50 )
	love.graphics.print( "txt2="..txt2.."" , 0 , 80 )
	love.graphics.print( "txt3="..txt3.."" , 0 , 120 )
	love.graphics.print( "tool_eta="..mouse.eta.."" , 500 , 20 )
	clav_draw()
