fonction = {}
function new_function(rep,nom,prio)--repertoire , nom de la liste , priorité d'éxécution

	rapporter_erreur("	-( gargement de la fonction \""..nom.."\" en priorité "..prio.."")
	local fonc = 0
	...
	local new = { prio = prio }
	rapporter_erreur("	fonction "..nom.." "..prio.." chargé )-")
...
function execute_fonction(fonc,P1,P2,P3,P4,P5,P6,P7,P8,P9,P10)
	if fonc ~= nil then
		...
		rapporter_erreur("		--appel de fonctions inéxistantes, éxécution impossible!--")
	end
end
function execute(fonc,P1,P2,P3,P4,P5,P6,P7,P8,P9,P10)
	if fonc then
		...
		rapporter_erreur("		--fonction introuvable éxécution impossible!--")
		return false
	end
end
function execute_en_silence(fonc,P1,P2,P3,P4,P5,P6,P7,P8,P9,P10)
	if fonc then
		return fonc(P1,P2,P3,P4,P5,P6,P7,P8,P9,P10)
	else
		return false
