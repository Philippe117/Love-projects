...
function set_clavier(emplacement,nom,X,Y)
	if emplachemen[nom] == nil then
		clavier.texte = ""
	else
		clavier.texte = emplachemen[nom]
	end
	clavier.X = X
	clavier.Y = Y
	clavier.emplacement = ""
	clavier.nom = ""
	clavier.texte_mem = clavier.texte
	clavier.actif = true
	clavier.crono = 0
end
...
function ok_clavier()
	...
	clavier.actif = false
	--clavier.id = 0
	if clavier.emplacement == nil then
		_G[""..clavier.nom..""] = clavier.texte
	else
		clavier.emplacement[clavier.nom] = clavier.texte
	end
