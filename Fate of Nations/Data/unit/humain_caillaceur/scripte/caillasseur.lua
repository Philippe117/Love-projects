	...
	if Q.etat == "vivant" then
		...
		elseif Q.mode == "combat" then
			...
			or dist > T.range+30 then
				...
				Q.mem , out = frame_pulse(Q.app[1],T.anim_atack,3,Q.mem)
				if out == true then
					--unit_hit(Q.cible,10,"normal")


					local new = unit_create(Q.projectile,Q.equipe,Q.X,Q.Y,Q.Z+25,1)
					...
					Q.app[1].app.speed = math.random(60,80)/100
